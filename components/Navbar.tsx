...
function Navbar() {
    return (
        <div className="w-[90%] flex justify-between mt-10 border-2 lg:py-2 items-center px-8 lg:px-12 rounded-[50px] font-alegreya bg-gradient-to-tr from-[#2C2D77] via-[#262664] to-[#1D1D44] border-[#3C468C]">
            <Link href="/">
                <Image src="/amsa-indonesia.png" height="10" width="250" alt="logo" className='h-[70px] hidden md:flex' />
                <Image src="/amsa-logo.png" height="10" width="50" alt="logo" className='md:hidden py-2' />
            </Link>
